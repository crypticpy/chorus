...
export function registerSystemRoutes(
  ...
  fastify.get<{
    ...
    try {
      const { fetchLatestVersion, versionGreater } =
        await import("../../cli/commands/update.js");
      const current = deps.version;
      const latest = await getCachedLatestVersion(() =>
        fetchLatestVersion("@crypticpy/polyphony"),
      );
  ...
  fastify.post<{
    ...
    try {
      ...
      const { validateCliPath, clearDetectionCache } =
        await import("../../lib/cli-detect.js");
  ...
  fastify.post<{
    ...
    try {
      const { connectByName, listOrchestrators } =
        await import("../orchestrators/index.js");
